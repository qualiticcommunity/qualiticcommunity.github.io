...
|**[B002]({{ site.baseurl }}{% link catalog/build_ci/B002.md%})**| Select and Enforce Code Style for Main Programming Languages. |
|**[B004]({{ site.baseurl }}{% link catalog/build_ci/B004.md%})**| Prevent Compiler Warning.|
